...
class ShareTests(TestCase):
    ...
    def setup_example(self):
        ...
        # Clear out all stored shares from previous iterations.
        cleanup_storage_server(self.anonymous_storage_server)

        # Also reset the state of the pass factory so this example starts with
        # all passes in the normal starting state.
